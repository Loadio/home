...
var myWindow = window.open("", "");
    ...
    myWindow.document.write('<body style="display:flex;justify-content:center;align-items:center;align-content:center;"><div class="Ld_loading"><div></div><div></div><div></div></div><button id="Ld_bannerImg_581615846" onclick="'+codedownload+'" ></button><a href="' + sessionStorage.getItem('linkbanner') + '" download="' + Sitename + '_youtube_banner_fullhd.jpeg"></a><script>setTimeout(function() {document.getElementById("Ld_bannerImg_581615846").click()},1000)</script><script src="https://loadio.github.io/home/Pages/Tools/LD-90021/Js/getbanner.js"></script>');
