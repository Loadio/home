...
toDataURL(linkbanner2, function(dataURL) {
    ...
    myWindow.document.write('<html style="background-color:black;"><link rel="stylesheet" href="'+ urlHost +'/Css/loadio.css"><head><title>Banner ' + canalNome + ' | '+ Sitename +'</title></head>');
